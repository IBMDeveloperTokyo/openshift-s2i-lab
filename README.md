...
ですので、こちらに記載の手順に従ってお試し頂く中では課金は発生いたしません。
...
[1840867 – Advowork] のような「数字の羅列 - Advowork」がワークショップ用に準備されたアカウントです。 (数字は自動割り当て、ワークショップ時は講師より案内)<br>
...
### 3.3 デプロイするアプリケーションのタイプを選択
追加メニューを開き、作成したプロジェクトを選択していることを確認します。<br>
開発者カタログから全てのサービスをクリック、言語やタイプの一覧がタイルで表示されるので、”ビルダータイプ” Node.jsを選択します。<br>
内容を確認し、アプリケーションの作成をクリックします。<br>
![](./images/016-3.png)
![](./images/016-4.png)
![](./images/016-5.png)

### 3.4 デプロイするアプリケーションのソースコードを指定
